      ...
      settings = {
        ...
        in {
          ...
          locked = layer [
            ...
            [["Ctrl Shift h"] {NewPane = "Left";}]
            [["Ctrl Shift l"] {NewPane = "Right";}]
            [["Ctrl Shift j"] {NewPane = "Down";}]
            [["Ctrl Shift k"] {NewPane = "Up";}]

            # Pane management
            [["Ctrl Shift z"] {ToggleFocusFullscreen = [];}]
            [["Ctrl Shift w"] {CloseFocus = [];}]

            # Scrollback
            [["Ctrl Shift o"] {EditScrollback = [];}]
          ];
          resize = layer [
